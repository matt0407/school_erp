<div class="fees index">
	...
	<tr>
		...
		<th><?php echo $this->Paginator->sort('fee_name'); ?></th>
		<th><?php echo $this->Paginator->sort('fee_cost'); ?></th>
		<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($fees as $fee): ?>
	<tr>
		<td><?php echo h($fee['Fee']['id']); ?>&nbsp;</td>
		<td><?php echo h($fee['Fee']['fee_name']); ?>&nbsp;</td>
		<td>$<?php echo h($fee['Fee']['fee_cost']); ?>&nbsp;</td>
		<td class="actions">
